...
- Create the console project (if starting from scratch):
...
- Add the Newtonsoft.Json package (if not already added):
  dotnet add package Newtonsoft.Json

- Restore dependencies (optional, dotnet build runs restore automatically):
  dotnet restore
...
-------------------------
When the app runs you'll see a numeric menu. Common actions:
